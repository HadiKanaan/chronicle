...
You are executing the Spec Kit command **/speckit.checklist** for the *Chronicle of the Velvet Lies* project.
...
Read the full, authoritative command instructions in @chronicle/.github/agents/speckit.checklist.agent.md and execute every step in order. That file is the single source of truth — follow it exactly. Do not duplicate or summarize its logic; perform it.
